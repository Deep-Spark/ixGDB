...
static struct type *
read_allocatable_array (struct type* type, const char **pp, struct objfile *objfile, int allocatable, long offset); 
...
static struct type *
read_xlf_char_type(const char** pp, struct type* rettype, struct objfile *objfile)
{
  ...
  int bits;
  if ((*pp)[0] != '-' || (*pp)[1] != '2' || (*pp)[2] != ';')
    complaint (_("Unexpected stabs code %s"), *pp);
  ...
  switch (type_descriptor)
	...
	/* type attribute */
	{
	  ...
	  switch (*attr)
	    ...
	    case 'R':
	      type = dbx_alloc_type (typenums, objfile);
	      replace_type(type, read_type (pp, objfile));
	      if ((**pp) == 0) return type;
	      break;
...
#define NUMBER_RECOGNIZED 36
  ...
  int fortran = (get_current_subfile ()->language = language_fortran);
  ...
  switch (-typenum)
    ...
    case 1:
      /* The size of this and all the other types are fixed, defined
         ...
         See stabs.texinfo.  */
      rettype = init_integer_type (objfile, 32, 0, fortran ? "integer" : "int");
      break;
    case 2:
      rettype = init_integer_type (objfile, 8, 0, fortran ? "character" : "char");
      TYPE_NOSIGN (rettype) = 1;
      break;
    case 3:
      rettype = init_integer_type (objfile, 16, 0, fortran ? "integer*2" : "short");
      break;
    case 4:
      rettype = init_integer_type (objfile, 32, 0, fortran ? "integer*4" : "long");
      break;
    case 5:
      rettype = init_integer_type (objfile, 8, 1, fortran ? "logical*1" : "unsigned char");
      break;
    case 6:
      rettype = init_integer_type (objfile, 8, 0, fortran ? "integer*1" : "signed char");
      break;
    case 7:
      rettype = init_integer_type (objfile, 16, 1, fortran ? "logical*2" : "unsigned short");
      break;
    case 8:
      rettype = init_integer_type (objfile, 32, 1, fortran ? "logical*4" : "unsigned int");
      break;
    case 9:
      rettype = init_integer_type (objfile, 32, 1, fortran ? "logical*4" : "unsigned");
      break;
    case 10:
      rettype = init_integer_type (objfile, 32, 1, fortran ? "logical*4" : "unsigned long");
      break;
    case 11:
    ...
    case 12:
      ...
      rettype = init_float_type (objfile, 32, fortran ? "real" : "float",
				 floatformats_ieee_single);
      break;
    case 13:
      /* IEEE double precision (64 bit).  */
      rettype = init_float_type (objfile, 64, fortran ? "real*8" : "double",
    ...
    case 14:
      ...
      rettype = init_float_type (objfile, 64, fortran ? "real*16" : "long double",
				 floatformats_ieee_double);
      break;
    case 15:
      rettype = init_integer_type (objfile, 32, 0, fortran ? "integer*4" : "integer");
      break;
    case 16:
      rettype = init_boolean_type (objfile, 32, 1, fortran ? "logical" : "boolean");
      break;
    case 17:
      rettype = init_float_type (objfile, 32, fortran ? "real" : "short real",
				 floatformats_ieee_single);
      break;
    case 18:
      rettype = init_float_type (objfile, 64, fortran ? "real*8" : "real",
				 floatformats_ieee_double);
      break;
    case 19:
    ...
    case 25:
      ...
      rettype = init_complex_type (objfile, fortran ? "complex*8" : "complex",
				   rs6000_builtin_type (12, objfile));
      break;
    case 26:
      /* Complex type consisting of two IEEE double precision values.  */
      rettype = init_complex_type (objfile, fortran ? "complex*16" : "double complex",
    ...
    case 30:
      ...
      break;
    case 31:
      rettype = init_integer_type (objfile, 64, 0, fortran ? "integer*8" : "long long");
      break;
    case 32:
      rettype = init_integer_type (objfile, 64, 1, fortran ? "logical*8" : "unsigned long long");
      break;
    case 33:
    ...
    case 34:
      ...
      break;
    case 35:
      rettype = init_integer_type (objfile, 64, 1, fortran ? "logical*8" : "unsigned long");
      break;
    case 36:
      rettype = init_integer_type (objfile, 64, 1, fortran ? "logical*8" : "unsigned long");
      break;
...
stabs_evaluate_allocated_safely (void *baton, struct value *val, void* frame)
{
  ...
  if (TYPE_CODE (type) == TYPE_CODE_PTR) 
  ...
  else 
    {
      ...
      stabs_create_generic_allocated_baton (type, (struct stabs_alloc_baton *) baton, range_type);
		 ...
		 struct objfile *objfile)
{
  ...
  */
  ...
  if ((**pp < '0' || **pp > '9') && **pp != '-')
      ...
      switch (**pp)
	{
	  ...
	  case 't':
	    ...
	    break;
	  default:
	    complaint (_("Array bound type %c not handled yet"), **pp);
	    break;
	}
    }
  else
  ...
  range_type =
    create_static_range_type_d ((struct type *) NULL, index_type, lower, upper, lower_baton, upper_baton, NULL, (LONGEST (*)(void*, CORE_ADDR, void*)) &stabs_evaluate_bound);
  /* XLF emits arrays with minor dimension first, but GDB expects major dimension first.  */
  if (get_current_subfile ()->language == language_fortran
