...
i386_darwin_dr_set (int regnum, CORE_ADDR value)
{
  ...
  ret = thread_set_state (current_thread, dr_regs.dsh.flavor,
                          (thread_state_t) &dr_regs.uds, count);
...
#include "cuda-linux-nat-template.c"

/* Was: static struct i386_darwin_nat_target darwin_target; */
static cuda_nat_linux<i386_darwin_nat_target> darwin_target;
