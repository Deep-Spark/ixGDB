...
salpy_str (PyObject *self)
{
  ...
  return gdbpy_StringFromFormat ("symbol and line for %s, line %d", filename,
			      sal->line);
}
...
salpy_dealloc (PyObject *self)
{
  ...
  else if (self_sal->symtab != gdbpy_None)
    set_objfile_data
