...
static CORE_ADDR cudbgDumpBufKmemHandleAddr;
static CORE_ADDR cudbgInferiorCtxHandleAddr;
static CORE_ADDR cudbgVirtualPcOffsetAddr;
...
cudbgInitialize(void)
{
    ...
    char *ipc_buf;
#ifndef GDBSERVER
    cudbgDumpBufKmemHandleAddr = cuda_get_symbol_address (_STRING_(CUDBG_DUMP_BUF_KMEM_HANDLE));
    cudbgInferiorCtxHandleAddr = cuda_get_symbol_address (_STRING_(CUDBG_INFERIOR_CTX_HANDLE));
    cudbgVirtualPcOffsetAddr = cuda_get_symbol_address (_STRING_(CUDBG_VIRTUAL_PC_OFFSET));
#endif
