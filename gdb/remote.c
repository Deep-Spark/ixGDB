...
class extended_remote_target /* CUDA final */ : public remote_target
{
public:
  const target_info &info () const override
...
void
getpkt (gdb::char_vector *buf, int forever)
{
  getpkt (get_current_remote_target (), buf, forever);
}
